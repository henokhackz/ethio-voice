...
const STATISTICS = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center py-8 my-6">
      ...
      <div className="w-full flex flex-wrap items-center justify-around gap-2 rounded">
        {statsData.map((stat, index) => (
          <div
            key={index}
            className="border border-secondary/10 p-4 rounded-md shadow-md w-[200px] md:w-[250px] h-[150px] text-center px-4 py-2"
          >
